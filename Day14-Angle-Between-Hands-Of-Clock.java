 ...
 * Constraints:
 * 
 * 1 <= hour <= 12 0 <= minutes <= 59 Answers within 10^-5 of the actual value
 * will be accepted as correct. Hide Hint #1 The tricky part is determining how
 * the minute hand affects the position of the hour hand. Hide Hint #2 Calculate
 * the angles separately then find the difference.
 */
